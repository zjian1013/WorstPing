...
namespace Syndra
{
    ...
    {
        private static readonly HashSet<Obj_AI_Hero> EnemyHeroes = new HashSet<Obj_AI_Hero>();
        private static readonly HashSet<Obj_AI_Minion> EnemyMinions = new HashSet<Obj_AI_Minion>();
        private static int _lastTickUpdate = (int) (Game.ClockTime * 0x3E8);
        ...
        {
            if ((int) (Game.ClockTime * 0x3E8) - _lastTickUpdate > 0x3E8)
            {
                EnemyMinions.Clear();
                ...
                _lastTickUpdate = (int) (Game.ClockTime * 0x3E8);
                return;
            }
        ...
        public static Obj_AI_Hero[] GetHeroes()
        {
