...
namespace Syndra
{
    public class Audio
    {
        private static int _lastPlayerSoundTick = (int) (Game.ClockTime * 0x3E8);
        ...
        public static void PlaySound(SoundPlayer sound = null)
        {
            ...
            else if ((int) (Game.ClockTime * 0x3E8) - _lastPlayerSoundTick > 45000 &&
                     EntryPoint.Menu.Item("l33t.stds.misc.sounds").GetValue<bool>())
            {
                ...
                _lastPlayerSoundTick = (int) (Game.ClockTime * 0x3E8);
            }
        }
    }
}