...
namespace Syndra
{
    ...
    {
        public static double GetComboDamage(this Obj_AI_Hero target, bool useQ, bool useW, bool useE, bool useR)
        {
            ...
            {
                var manaCost = Mechanics.Spells[SpellSlot.R].Instance.Instance.ManaCost;
            ...
            {
                var manaCost = Mechanics.Spells[SpellSlot.Q].Instance.Instance.ManaCost;
                if (comboMana + manaCost <= mana)
                {
                    comboMana += manaCost;
            ...
            {
                var manaCost = Mechanics.Spells[SpellSlot.W].Instance.Instance.ManaCost;
                if (comboMana + manaCost <= mana)
                {
                    comboMana += manaCost;
            ...
            {
                var manaCost = Mechanics.Spells[SpellSlot.E].Instance.Instance.ManaCost;
                if (comboMana + manaCost <= mana)
                {
