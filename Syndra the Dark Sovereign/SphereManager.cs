...
namespace Syndra
{
    public class SphereManager
    {
        ...
        private static Obj_AI_Minion ForceOfWill(bool sphere)
        {
            ...
            var obj = ObjectManager.GetUnitByNetworkId<Obj_AI_Base>(ObjectNetworkId);
        ...
        public static List<Vector3> GetSpheres(bool toGrab = false)
        {
            ...
            if ((int) (Game.ClockTime * 0x3E8) - _sphereTick < 400)
            {
                result.Add(_sphereVector3);
            }

            if ((int) (Game.ClockTime * 0x3E8) - _sphereStasisTick < 400 && (int) (Game.ClockTime * 0x3E8) > 0)
            {
